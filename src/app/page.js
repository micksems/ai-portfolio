...
const actionButtonClass =
  "inline-flex h-12 items-center justify-center whitespace-nowrap rounded-full border border-white/15 bg-white/[0.03] px-6 text-sm font-medium !text-white visited:!text-white hover:!text-white transition-all duration-200 hover:border-white/32 hover:bg-white/[0.07]";
const navItems = [
          ...
          <div className="max-w-3xl text-center lg:text-left" data-reveal>
            ...
            <h1 className="mt-6 text-5xl font-semibold leading-[1.01] tracking-[-0.045em] text-white sm:text-6xl md:text-7xl lg:text-[5.15rem]">
              ...
              <span className="hero-word-wrap mt-1 block">
                <span className="hero-word hero-word-primary">
